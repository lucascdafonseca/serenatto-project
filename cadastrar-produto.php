...
<main>
    ...
    <section class="container-form">
        <form action="src/service/insertProduct.php" method="post">
            ...
            <input type="text" id="preco" name="price" placeholder="Digite uma descrição" required>

            <label for="imagem">Envie uma imagem do produto</label>
            <input type="file" name="imageName" accept="image/*" id="imagem" placeholder="Envie uma imagem">
